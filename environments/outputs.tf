...
# Helper outputs for Ansible
output "asg_name" {
  description = "Auto Scaling Group name for querying instances"
  value       = module.ec2.autoscaling_group_name
}

output "instance_tag_filters" {
  description = "Tags to filter EC2 instances for Ansible inventory"
  value = {
